...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2021 at 07:32 AM
...
INSERT INTO `login` (`login_id`, `user_role_id`, `user_name`, `user_password`, `user_image`, `user_email`, `created_date`, `updated_date`, `status`) VALUES
(1, 1, 'admin', '0192023a7bbd73250516f069df18b500', 'user_default.png', 'admin@medical.eq', '2020-08-23 16:56:24', '2020-08-23 16:56:24', 1),
(3, 1, 'abdul', '428a78b4fee47253898d7918c0a09160', 'user_default.png', 'tname3186@gmail.com', '2020-11-27 22:08:34', '2020-11-27 22:08:34', 1),
(17, 2, 'ayankhan', 'c38128384338ea72e150219233f892e2', 'img_5_1617690537.jpg', 'ayankhan78657.ak@gmail.com', '2021-04-06 11:59:03', '2021-04-06 11:59:03', 1);
...
(1, 'test name', 'test@gmail.com', 'cc03e747a6afbbcbf8be7668acfebee5', '127', 'Test address', 'user_default.png', 'Test address', '2020-10-01 04:13:45', '2020-10-01 04:13:45', 1),
(2, 'abdulrahim', 'abdul123@gmail.com', 'abdul123', '127', 'gujarat surat', 'user_default.png', 'gujarat surat', '2020-10-01 04:41:54', '2020-10-01 04:41:54', 1),
(6, 'mike ', 'mike123@gmail.com', '4c3e1ec04215f69d6a8e9c023c9e4572', '127', 'indiana usa', 'user_default.png', 'North America', '2020-10-01 05:09:31', '2020-10-01 05:09:31', 1),
(10, 'dummy123', 'dummy@gmail.com', '851fdee206c1eec10cee5ec8e8962af2', '8899776655', 'dummy address', 'user_default.png', 'dummy delivery address', '2020-11-20 13:56:30', '2020-11-20 13:56:30', 1),
(11, 'bro123', 'bro123@gmail.com', 'e1dc3f127b005d94ed22d7c5e48b0f61', '8877665554', 'bro address', 'user_default.png', 'bro address', '2020-11-20 14:06:36', '2020-11-20 14:06:36', 1);
...
INSERT INTO `user_role` (`user_role_id`, `user_role_name`, `user_role_slug`, `created_date`, `updated_date`, `status`) VALUES
(1, 'Admin', 'admin', '2021-04-01 09:56:26', '2021-04-01 09:56:26', 1),
(2, 'Subscriber', 'subscriber', '2021-04-01 09:57:26', '2021-04-01 09:57:26', 1);
...
(1, 'site_title', 'Medical Store', '2020-10-30 17:11:00', '0000-00-00 00:00:00', 1),
(2, 'default_currency ', '$', '2020-11-01 14:09:59', '0000-00-00 00:00:00', 1),
(3, 'site_icon', 'favicon_1617728642.png', '2020-11-01 14:09:59', '0000-00-00 00:00:00', 1);
...
--
ALTER TABLE `category`
  MODIFY `category_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `password_reset`
  MODIFY `pw_reset_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `product`
--
ALTER TABLE `product`
  MODIFY `product_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `login`
  ADD CONSTRAINT `login_ibfk_1` FOREIGN KEY (`user_role_id`) REFERENCES `user_role` (`user_role_id`) ON DELETE CASCADE ON UPDATE CASCADE;
